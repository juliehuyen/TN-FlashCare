from chat_service.domain.model.system_prompt import SystemPrompt

class SystemPromptService:
    def __init__(self):
        # Initialisez le prompt par défaut
        self.system_prompt = SystemPrompt(
             content = """You are a virtual assistant designed to answer hospitalized patients’ questions about prescriptions, medications, dosages, administration routes, drug interactions, and common side effects.Add commentMore actions
